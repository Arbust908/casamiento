...
import { useGeneralStore, PossibleModals } from '@/composables/general'
...
<template>
    ...
    <section class="relative h-9/10">
        ...
        >
            ...
            <h2 class="text-3xl">Hola {{ data?.name }}!!!</h2>
        </div>
        <InviteTopCurve
    ...
    <section class="bg-slate-800 relative py-10">
        ...
        <div
            class="flex flex-col gap-y-8 lg:flex-row lg:gap-x-24 lg:gap-y-0 items-center justify-center lg:items-start"
        >
    ...
    <section class="bg-slate-800 px-6 flex flex-col justify-center text-center">
        <InviteGoldenLines2 />
        <h2 class="text-4xl font-light">Fiesta</h2>
        <p class="mb-14">
    ...
    <section class="relative bg-gradient-to-b from-slate-700 to-slate-600">
        ...
        <div class="max-w-sm mx-auto px-4 text-center space-y-12">
            <h2 class="text-3xl">Compartimos este día junto a vos</h2>
            <p class="px-4">Compartí tus fotos y videos de ese hermoso día</p>
